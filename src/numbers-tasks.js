...
function getFibonacciNumber(index) {
  ...
  for (let i = 2; i <= index; i += 1) {
    numbers.firstPrev = numbers.secondPrev;
    numbers.secondPrev = numbers.value;
    numbers.value = numbers.firstPrev + numbers.secondPrev;
  }
...
function getCountOfOddNumbers(number) {
  ...
  return number % 2 !== 0 ? (Math.floor(num) + 1) / 2 : Math.floor(num) / 2;
}
